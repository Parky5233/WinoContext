...
with open("responses/rob_resp_2.json", "r") as file1:
    resp_0 = json.loads(file1.read())

with open("responses/rob_resp_3.json","r") as file2:
...
print("Robustness of Resp 2 = "+str(count/(len(keys)/2)))
...
print("Robustness of Resp 3 = "+str(count/(len(keys)/2)))